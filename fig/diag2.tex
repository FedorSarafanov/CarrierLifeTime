...
extra x tick labels={ % их подписи
    ...
    % \draw (axis cs:0,0) circle [blue, radius=1];
        \addplot[thick,smooth] table[col sep=tab]{data/11.tsv} node[pos=0.5] {};
        \addplot[thick,smooth] table[col sep=tab]{data/12.tsv} node[pos=0.5] {};

        \addplot[domain=0:1, samples=300]{-56.11*x^2 + 51.71*x + (-13.23)-0.6};
        \addplot[smooth,thick,yshift=-0.2pt, xshift=-3pt] table[col sep=tab]{data/13.tsv} node[pos=0.5] {};
        ...
        \draw[densely dashed,-latex] (-0.0038564,  0.317771) -- (0.383052,  -1.46838);
        \draw[densely dashed,latex-] (-0.00224839, 0.315161) -- (0.442251,  -1.30069);

        \draw[-latex] (0.407829,  -1.38256) -- (0.407366,  0.433318);
        \draw[-latex] (0.498328,  0.304094) -- (0.498532,  -1.39203);


        \draw[densely dashed,latex-] (0.997955,  0.419297) -- (0.48842, -1.35945);
        \draw[densely dashed,latex-] (0.513249,  -1.4767) -- (0.998408,  0.442726);
